/*
** my_check_zor.c for  in /home/mesqui_v/rendu/Tek1/S2/CPE/Corewar/CPE_2015_corewar/asm
**
** Made by vincent mesquita
** Login   <mesqui_v@epitech.net>
**
** Started on  Thu Mar 24 12:42:48 2016 vincent mesquita
** Last update Sat Mar 26 21:58:17 2016 vincent mesquita
*/

#include "asm.h"

int			my_check_zor(char **wordtab,
				     t_header *header,
				     t_file_info *fi)
{
  int			index_op;
